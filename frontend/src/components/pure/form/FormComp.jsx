...
export function FormComp({ formRegisterTitle, showPassField, showDropzone }) {
  ...
  return (
    <div className='formCompRegister mt-4 ms-3 me-3'>
      ...
      <Form className='formCompRegister-Content'>
        <Row>
          <Col xs={12} md={4} lg={4}>
            <Form.Group className="form-floating mb-3 formCompRegister-name" controlId="formBasicName">
              ...
              <Form.Control className='formCompRegister-field' type="text" placeholder="Nombre" />
            </Form.Group>
          </Col>
          <Col xs={12} md={4} lg={4}>
            <Form.Group className="form-floating mb-3 formCompRegister-lastname_1" controlId="formBasicLastname_1">
              ...
              <Form.Control className='formCompRegister-field' type="text" placeholder="Primer apellido" />
            </Form.Group>
          </Col>
          <Col xs={12} md={4} lg={4}>
            <Form.Group className="form-floating mb-3 formCompRegister-lastname_2" controlId="formBasicLastname_2">
              ...
              <Form.Control className='formCompRegister-field' type="text" placeholder="Segundo apellido" />
            </Form.Group>
          </Col>
        </Row>
        <Row>
          ...
          <Col xs={9} md={4} lg={4}>
            <Form.Group className="form-floating mb-3 formCompRegister-document" controlId="formBasicDocument">
              ...
              <Form.Control className='formCompRegister-field' type="text" placeholder={docType} />
            </Form.Group>
          </Col>
          <Col xs={12} md={6} lg={6}>
              ...
              <div className="dropdown">
                <Dropdown onSelect={handleDropdownChange}>
                  ...
                  <Dropdown.Menu className='menu-specialization'>
                    <Dropdown.Item className='menuList-spec' eventKey="1">Salsa</Dropdown.Item>
                    <Dropdown.Item className='menuList-spec' eventKey="2">Bachata</Dropdown.Item>
                    <Dropdown.Item className='menuList-spec' eventKey="3">Merengue</Dropdown.Item>
                    <Dropdown.Item className='menuList-spec' eventKey="3">Merengue</Dropdown.Item>
                    <Dropdown.Item className='menuList-spec' eventKey="3">Salsa</Dropdown.Item>
                    <Dropdown.Item className='menuList-spec' eventKey="3">Bachata</Dropdown.Item>
                    <Dropdown.Item className='menuList-spec' eventKey="3">Merengue</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </div>
        ...
        <Row>
          <Col xs={12} md={6} lg={6}>
            <Form.Group className="form-floating mb-3 formCompRegister-email" controlId="formBasicEmail">
              ...
              <Form.Control className='formCompRegister-field' type="email" placeholder="example@gmail.com" />
            </Form.Group>
          </Col>
          <Col xs={12} md={6} lg={6}>
            <Form.Group className="form-floating mb-3 formCompRegister-phone" controlId="formBasicPhone">
              ...
              <Form.Control className='formCompRegister-field' type="phone" placeholder="616456456" />
            </Form.Group>
          </Col>
        </Row>
        {showPassField && (
            ...
            <Row>
              <Col>
                <Form.Group className="form-floating mb-3 formCompRegister-pass" controlId="formBasicPassword_1">
                  ...
                  <Form.Control className='formCompRegister-field' type={passwordField.password_1.type} placeholder="Contraseña" />
                  <div className="input-icon" onClick={() => handleShowPassword('password_1')}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                      {
                        passwordField.password_1.visible ?
                          (<>
        ...
        <div className='formCompRegister-buttonContent'>
